...
root.title('TEXT_TO_SPEECH(Shrey Kharbanda)')


##heading
Label(root, text = 'TEXT TO SPEECH', font='arial 20 bold', bg ='#FFE873').pack()
Label(root, text ='Shrey Kharbanda', font ='arial 15', bg = '#FFE873').pack(side = BOTTOM)
#label
...
def Text_to_speech():
    ...
    playsound(r'D:\ScreenRecorder\python.mp3')
