...
root = Tk()
root.title("Translator: Shrey Kharbanda")
...
choices = { 'English','Hindi','Gujarati','Spanish','German','French','Latin','Greek','Chinese'}
...
var1 = StringVar()
textbox = Entry(mainframe, textvariable=var1).grid(row=2,column=2)
